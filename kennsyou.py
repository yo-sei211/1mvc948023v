...
rm.run_angle(-700,395,Stop.BRAKE)
lm.reset_angle (0) 
rm.reset_angle (0)
while lm.angle() >= -110:
    pd()
...
rm.reset_angle (0)
while True:
    print(bl1,bl2,bl3,bl4,bl5,bl6,bl7,bl8)
#ココマデ
ev3.speaker.beep()
print(bl1,bl2,bl3,bl4,bl5,bl6,bl7,bl8)
robot.stop(Stop.BRAKE)
...
while lm.angle()>= -50:
    lm.run(-100)
    rm.run(-100)
Mlm.run_angle(200, -187, Stop.BRAKE)
Mrm.run_angle(200, 110, Stop.BRAKE)
lm.reset_angle (0) 
rm.reset_angle (0) 
while lm.angle() <= 230:
    lm.run(300)
